...
final class UserStatusDetailController extends AbstractController
{
    #[Route('/user/status/detail/{id}', name: 'app_user_status_detail')]
    public function index(EntityManagerInterface $entityManager, $id): Response
    {
        ...
        return $this->render('user_status/userStatudDetail.html.twig', [
